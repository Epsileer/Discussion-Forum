<table align="center" width="780px" border="1" bgcolor="pink" cellspacing="0"> 
	...
	<tr align="center">
		...
		<td><img style="height: 30px;width: 30px;" src="../user/user_images/<?php echo $user_image; ?>"></td>
		<td><?php echo $user_country; ?></td>
		<td><?php echo $user_gender; ?></td>
		<td><a href="includes/delete_user.php?delete=<?php echo $user_id; ?>">Delete</a></td>
...
$update="update users set user_name='$u_name',user_pass='$u_pass', user_email='$u_email',user_country='$user_country', user_image='$u_image' where user_id='$user_id'";
...
if($run)
{
	echo "<script> alert('user has been is updated')</script>";
